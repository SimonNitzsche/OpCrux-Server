#ifndef __ENTITY__GM__TransferToZone_HPP__
#define __ENTITY__GM__TransferToZone_HPP__
...
namespace GM {
	struct TransferToZone : GMBase {

		inline constexpr static Enums::EGameMessageID GetID() {
			return Enums::EGameMessageID::SERVER_TRANSFER_TO_ZONE;
		}
		...
		TransferToZone() : GMBase() {}

		void Serialize(RakNet::BitStream* bs) {
			GM_VAR_SERIALIZE_WITH_DEFAULT(bs, bCheckTransferAllowed, false);
			GM_VAR_SERIALIZE_WITH_DEFAULT(bs, cloneID, -1);

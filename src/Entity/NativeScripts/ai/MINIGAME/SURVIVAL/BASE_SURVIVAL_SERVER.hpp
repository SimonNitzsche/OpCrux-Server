#ifndef __ENTITY__NATIVESCRIPTS__AI__MINIGAME__SURVIVAL__BASE_SURVIVAL_SERVER_HPP__
#define __ENTITY__NATIVESCRIPTS__AI__MINIGAME__SURVIVAL__BASE_SURVIVAL_SERVER_HPP__

#ifndef __ENTITY__NATIVESCRIPT__AI__RACING__RACE_IMAGINATION_SPAWNER_HPP__
#define __ENTITY__NATIVESCRIPT__AI__RACING__RACE_IMAGINATION_SPAWNER_HPP__

#include <string>
#include "Entity/GameObject.hpp"
#include "Entity/NativeScript.hpp"

class NATIVESCRIPT__AI__RACING__RACE_IMAGINATION_SPAWNER {
public:
/*
--------------------------------------------------------------

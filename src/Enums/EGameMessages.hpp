...
namespace Enums {
	...
	*/
	enum EGameMessageID : unsigned short {
		...
		INTERN_ACTIVATE_ND_AUDIO_MUSIC_CUE = 827,
		INTERN_DEACTIVATE_ND_AUDIO_MUSIC_CUE = 828,

...
public:
	...
	static void GetAllNonMissionsThatAreMissingByTaskType(Entity::GameObject * player, std::map<int32_t, std::map<std::int32_t, std::int32_t>>* selection, std::list<DatabaseModels::MissionModel>* currentMissions);

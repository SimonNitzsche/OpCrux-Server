...
public:
	...
	void AddTimerWithCancelMs(int timeInMs, const std::u16string& name, Entity::GameObject * object);
	void AddTimerWithCancel(float timeInSeconds, const std::u16string& name, Entity::GameObject * object);
}; 
